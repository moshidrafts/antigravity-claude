...
Never drop not/never/no/only/except flip meaning worse than any token saved. Numbers, units exact. Never use section symbol (§ silcrow); use standard numbers or headings.
